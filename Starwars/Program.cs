...
namespace Starwars
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //OPG 1
            //foreach (Planet planet in GetOnlyMPlanets(planets))
            //{
            //    Console.WriteLine(planet.Name);
            //}

            //OPG 2
            //foreach (Planet planet in GetPlanetsContainsY(planets))
            //{
            //    Console.WriteLine(planet.Name);
            //}

            //OPG 3
            //foreach (Planet planet in GetPlanetsSpecificLength(planets))
            //{
            //    Console.WriteLine(planet.Name);
            //}

            //OPG 4
            //foreach (Planet planet in GetPlanetsAOnSecondPosAndEndsWithE(planets))
            //{
            //    Console.WriteLine(planet.Name);
            //}

            //OPG 5
            //foreach (Planet planet in GetPlanetsRotationPeriodLargerThan40(planets))
            //{
            //    Console.WriteLine(planet.Name);
            //}

            //OPG 6
            //foreach (Planet planet in GetPlanetsRotationPeriodBetween10And20(planets))
            //{
            //    Console.WriteLine(planet.Name);
            //}

            //OPG 7
            //foreach (Planet planet in GetPlanetsRotationPeriodBiggerThan30OrderByNameAndRotation(planets))
            //{
            //    Console.WriteLine(planet.Name);
            //}
            ...
            //OPG 9
            //foreach (Planet planet in GetPlanetsBySurfaceWater(planets))
            //{
            //    Console.WriteLine(planet.Name);
            //}

            //OPG 10
            //foreach (Planet planet in GetPlanetResidentAvailableArea(planets))
            //{
            //    Console.WriteLine(planet.Name);
            //}

            //OPG 11
            //foreach (Planet planet in GetPlanetsRotationWithExcept(planets))
            //{
            //    Console.WriteLine(planet.Name);
            //}

            //OPG 12
            //foreach (Planet planet in GetUnionedLists(planets))
            //{
            //    Console.WriteLine(planet.Name);
            //}
            ...
            //OPG 15
            //foreach (Planet planet in GetPlanetsDoubleVowel(planets))
            //{
            //    Console.WriteLine(planet.Name);
            //}

            //OPG 16
            //foreach (Planet planet in GetPlanetsDoubleKLRN(planets))
            //{
            //    Console.WriteLine(planet.Name);
            //}
        ...
        //Opg 1
        static IEnumerable<Planet> GetOnlyMPlanets(List<Planet> planets)
        {
            return from planet in planets where planet.Name.StartsWith("M") select planet;
        }

        //Opg 2
        static IEnumerable<Planet> GetPlanetsContainsY(List<Planet> planets)
        {
            return from planet in planets where planet.Name.ToLower().Contains("y") select planet;
        }

        //Opg 3
        static IEnumerable<Planet> GetPlanetsSpecificLength(List<Planet> planets)
        {
            return from planet in planets where planet.Name.Length > 9 && planet.Name.Length < 15 select planet;
        }

        //Opg 4
        static IEnumerable<Planet> GetPlanetsAOnSecondPosAndEndsWithE(List<Planet> planets)
        {
            return from planet in planets where planet.Name[1] == 'a' && planet.Name.EndsWith("e") select planet;
        }

        //Opg 5
        static IEnumerable<Planet> GetPlanetsRotationPeriodLargerThan40(List<Planet> planets)
        {
            return from planet in planets where planet.RotationPeriod > 40 orderby planet.RotationPeriod select planet;
        }

        //Opg 6
        static IEnumerable<Planet> GetPlanetsRotationPeriodBetween10And20(List<Planet> planets)
        {
        ...
        //Opg 7
        static IEnumerable<Planet> GetPlanetsRotationPeriodBiggerThan30OrderByNameAndRotation(List<Planet> planets)
        {
            return from planet in planets
        ...
        //Opg 9
        static IEnumerable<Planet> GetPlanetsBySurfaceWater(List<Planet> planets)
        {
            return from planet in planets
        ...
        //Opg 10
        static IEnumerable<Planet> GetPlanetResidentAvailableArea(List<Planet> planets)
        {
            return from planet in planets
                   where planet.Diameter > 0 && planet.Population > 0
                   let rad = planet.Diameter / 2
                   let squared = Math.Pow(rad, 2)
                   let surfaceArea = 4 * Math.PI * squared
                   orderby planet.Population / surfaceArea descending
                   select planet;
        }

        //Opg 11
        static IEnumerable<Planet> GetPlanetsRotationWithExcept(List<Planet> planets)
        {
            IEnumerable<Planet> otherList = from planet in planets
                                            where planet.RotationPeriod > 0
                                            select planet;

            return (from planet in planets
                    select planet).Except(otherList);
        }

        //Opg 12
        static IEnumerable<Planet> GetUnionedLists(List<Planet> planets)
        {
            IEnumerable<Planet> aOrSList = from planet in planets
                                           where planet.Name.ToLower().StartsWith("a") || planet.Name.EndsWith("s")
                                           select planet;
            IEnumerable<Planet> terrainList = from planet in planets
                                              where planet.Terrain != null && planet.Terrain.Contains("rainforests")
                                              select planet;

            return aOrSList.Union(terrainList);
        }

        //Opg 13
        static IEnumerable<Planet> GetPlanetsDesert(List<Planet> planets)
        {
        ...
        //Opg 14
        static IEnumerable<Planet> GetPlanetSwamps(List<Planet> planets)
        {
            IEnumerable<Planet> swamps = from planet in planets
                                         where planet.Terrain != null
                                         from terrain in planet.Terrain
                                         where terrain != null && terrain.Contains("swamp")
        ...
        //Opg 15
        static IEnumerable<Planet> GetPlanetsDoubleVowel(List<Planet> planets)
        {
            IEnumerable<Planet> sortedList = from planet in planets
                                             where Regex.IsMatch(planet.Name, @"([aeiou])\1")
                                             select planet;
        ...
        //Opg 16
        static IEnumerable<Planet> GetPlanetsDoubleKLRN(List<Planet> planets)
        {
            IEnumerable<Planet> sortedList = from planet in planets
                                             where Regex.IsMatch(planet.Name, @"([lkrn])\1")
